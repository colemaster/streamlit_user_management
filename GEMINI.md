...
2. **No Auth**: Redirects to Microsoft Login (OAuth2 flow).
3. **Callback**: Microsoft redirects back to `/oauth2callback` (handled implicitly or via redirect capture).
4. **Token Exchange**: Code is exchanged for an Access Token.
